...
from .views import home, about, contact, profile, update_student, add_student, delete_student, student_list, student_form,student_detail, HelloView, HomePageView, StudentListView, StudentDetailView
